...
We get 51 original features from fred.stlouisfed.org, which are various interests rate for different financial  products and a bunch of different values of some of those. Here are the title of each column data.
